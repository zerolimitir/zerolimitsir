...
export const LoadingText = ({ ...props }) => {
	return (
		<div role="status" className="max-w-sm animate-pulse" {...props}>
			...
			<div className="h-2 bg-gray-100 rounded-full dark:bg-gray-700 max-w-[300px] mb-2.5"></div>
...
export const LoadingImageText = ({ ...props }) => {
	return (
		<div
			role="status"
			className="max-w-sm p-4 shadow animate-pulse md:p-6 border-gray-700"
			{...props}>
	...
	return (
		<div role="status" className="space-y-2.5 animate-pulse max-w-lg">
			<div className="flex items-center w-full space-x-2">
				<div className="h-2.5 bg-gray-100 rounded-full dark:bg-gray-700 w-32"></div>
			...
			<div className="flex items-center w-full space-x-2 max-w-[480px]">
				<div className="h-2.5 bg-gray-100 rounded-full dark:bg-gray-700 w-full"></div>
				<div className="h-2.5 bg-gray-200 rounded-full dark:bg-gray-600 w-full"></div>
				<div className="h-2.5 bg-gray-200 rounded-full dark:bg-gray-600 w-24"></div>
			</div>
			<div className="flex items-center w-full space-x-2 max-w-[400px]">
				<div className="h-2.5 bg-gray-200 rounded-full dark:bg-gray-600 w-full"></div>
				<div className="h-2.5 bg-gray-100 rounded-full dark:bg-gray-700 w-80"></div>
				<div className="h-2.5 bg-gray-200 rounded-full dark:bg-gray-600 w-full"></div>
			</div>
			<div className="flex items-center w-full space-x-2 max-w-[480px]">
				<div className="h-2.5 bg-gray-100 rounded-full dark:bg-gray-700 w-full"></div>
